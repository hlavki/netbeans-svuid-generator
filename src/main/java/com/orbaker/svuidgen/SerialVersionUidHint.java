...
import com.orbaker.svuidgen.service.SerialVersionUIDService;
...
@Hint(displayName = "#DN_SerialVersionUID", description = "#DESC_SerialVersionUID", id = "com.orbaker.svuidgen.SerialVersionUidHint", category = "general", enabled = true, options = Options.QUERY, suppressWarnings = SvuidHelper.SUPPRESS_WARNING_SERIAL)
